            ...
            <div className="relative bg-[#12121a]/90 backdrop-blur-xl rounded-2xl">
              ...
              <div className="relative p-8 md:p-12">
                ...
                <div className="text-center mb-12">
                  ...
                  <h2 className="text-3xl font-semibold text-white mb-4">구독하기</h2>
                  <div className="flex items-baseline justify-center gap-2 mb-4">
                    ...
                    <span className="text-xl text-gray-400">월간 플랜</span>
                  </div>
                  <p className="text-gray-400 text-lg">모든 언어를 지원하며, 지금 바로 코딩하고 공유하세요!</p>
                </div>
